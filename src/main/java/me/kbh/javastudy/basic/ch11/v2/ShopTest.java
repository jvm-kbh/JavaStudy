...
public class ShopTest {
  ...
  public static List<CompletableFuture<String>> findPricesByExecutor(
      List<Shop> shopList, String product, Executor executor) {
    return shopList.parallelStream()
        .map(
            shop ->
  ...
  public static List<String> findPricesByExecutor2(
      List<Shop> shopList, String product, Executor executor) {
    return shopList.stream()
        .map(
            shop ->
